...
function Jobs(){
    ...
    function addInterest(item: string){
        setListInterests(item);
        setInterestsSet(item);
    }
    ...
    return(
        <div className="interestContainer">
            ...
            <input className="inputInterest" value={searchInput} onChange={(e) => setSearchInput(e.target.value)} placeholder="Search occupations..."></input>
